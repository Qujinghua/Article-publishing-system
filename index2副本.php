		...
		<div class="article article_size">
			...
			<div class="article_web">
				...
				<ul class="article_web_ul">
					...
					<!-- <li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $rows[0]['article_id'];?>"><img src="<?php echo $rows[0]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $rows[0]['article_id'];?>"><?php echo $rows[0]['title'];?></a></h3>
						<div class="article_digest"><?php echo $rows[0]['digest_content'];?></div>
					</li>
					<li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $rows[1]['article_id'];?>"><img src="<?php echo $rows[1]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $rows[1]['article_id'];?>"><?php echo $rows[1]['title'];?></a></h3>
						<div class="article_digest"><?php echo $rows[1]['digest_content'];?></div>
					</li>
					<li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $rows[2]['article_id'];?>"><img src="<?php echo $rows[2]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $rows[2]['article_id'];?>"><?php echo $rows[2]['title'];?></a></h3>
						<div class="article_digest"><?php echo $rows[2]['digest_content'];?></div>
					</li> -->
			...
			<div class="article_web">
				...
				<ul class="article_web_ul">
					...
					<!-- <li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $mobiles[0]['article_id'];?>"><img src="<?php echo $mobiles[0]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $mobiles[0]['article_id'];?>"><?php echo $mobiles[0]['title'];?></a></h3>
						<div class="article_digest"><?php echo $mobiles[0]['digest_content'];?></div>
					</li>
					<li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $mobiles[1]['article_id'];?>"><img src="<?php echo $mobiles[1]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $mobiles[1]['article_id'];?>"><?php echo $mobiles[1]['title'];?></a></h3>
						<div class="article_digest"><?php echo $mobiles[1]['digest_content'];?></div>
					</li>
					<li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $mobiles[2]['article_id'];?>"><img src="<?php echo $mobiles[2]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $mobiles[2]['article_id'];?>"><?php echo $mobiles[2]['title'];?></a></h3>
						<div class="article_digest"><?php echo $mobiles[2]['digest_content'];?></div>
					</li> -->
				</ul>
			</div>
			<div class="clear"></div>
			<div class="article_web">
				...
				<ul class="article_web_ul">
					...
					<!-- <li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $technologys[0]['article_id'];?>"><img src="<?php echo $technologys[0]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $technologys[0]['article_id'];?>"><?php echo $technologys[0]['title'];?></a></h3>
						<div class="article_digest"><?php echo $technologys[0]['digest_content'];?></div>
					</li>
					<li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $technologys[1]['article_id'];?>"><img src="<?php echo $technologys[1]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $technologys[1]['article_id'];?>"><?php echo $technologys[1]['title'];?></a></h3>
						<div class="article_digest"><?php echo $technologys[1]['digest_content'];?></div>
					</li>
					<li>
						<div class="article_img"><a href="article.php?article_id=<?php echo $technologys[2]['article_id'];?>"><img src="<?php echo $technologys[2]['digest_img'] ;?>"></a></div>
						<h3><a href="article.php?article_id=<?php echo $technologys[2]['article_id'];?>"><?php echo $technologys[2]['title'];?></a></h3>
						<div class="article_digest"><?php echo $technologys[2]['digest_content'];?></div>
					</li> -->
				</ul>
			</div>
			<div class="clear"></div>
			...
			<div class="new_article">
				...
				<!-- <div class="new_article_content">
					<article class="new_article_content_1">
						<div class="new_article_content_1_inner">
							<h2><a href="javascript:;">“好好告别，好好开始”</a></h2>
							<a class="new_article_img" href="javascript:;"><img src="images/fsdgfsd5455.jpg"></a>
							<section>回到北京的那天夜里，大象开车来机场接我说要带我去参加一个神秘的聚餐。车在东四环开的飞起，生怕晚一分钟...
								回到北京的那天夜里，大象开车来机场接我说要带我去参加一个神秘的聚餐。车在东四环开的飞起，生怕晚一分钟...
								回到北京的那天夜里，大象开车来机场接我说要带我去参加一个神秘的聚餐。车在东四环开的飞起，生怕晚一分钟</section>
							<div class="new_article_date"><span>2016/08/01</span><span class="new_article_date_down"></span></div>
							<footer class="new_article_footer"><span>156次浏览</span></footer>
						</div>
					</article>
				</div>
				<div class="new_article_content">
		...
		<div class="sidebar_content">
			...
			<div class="sidebar_content_article">
				...
				<ul class="sidebar_content_article_hot" style="display:block;">
					...
					<!-- <li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
					<li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
					<li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
					<li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
					<li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
				...
				<ul class="sidebar_content_article_new" style="display:none;">
					...
					<li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
					<li><a href="">web前段开发教程和知道</a><span>(152)</span></li>
					<li><a href="">web前段开发教程和知道</a><span>(151)</span></li> -->
				</ul>
			</div>
		</div>
	</div>
